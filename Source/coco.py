...
def _load_records(train=True, val=False):
    """
    Load the image-filenames and captions
    for either the training-set or the validation-set.
    """
...
def load_records(train=True, val=False):
    """
    ...
    if train:
        ...
        cache_filename = "records_test.pkl"
